                        ...
                        <div class="card">
                            ...
                            <table class="table table-striped">
                                ...
                                <tr>
                                    <td>NPWP</td>
                                    <td>:</td>
                                    <td><a href="{{asset('lampiran/permohonan-tanah/'.$data->npwp)}}" target="_blank"
                                            class="btn btn-sm btn-success"><i class="fa fa-paperclip"></i>
                                            NPWP</a></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>SPPT PBB</td>
                                    <td>:</td>
                                    <td><a href="{{asset('lampiran/permohonan-tanah/'.$data->sppt)}}" target="_blank"
                                            class="btn btn-sm btn-success"><i class="fa fa-paperclip"></i>
                                            SPPT PBB</a></td>
                                </tr>
                            </table>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md text-right">
                                        <div class="col-md text-right">
                                            @if ($data->status == 2)
                                            <form
                                                action="{{route('ketua_peneliti.permohonan_tanah_ketua_peneliti.update',$data->id)}}"
                                                method="POST">
                                                @csrf
                                                @method('put')
                                                <input type="hidden" name="status" value="3" id="" required>
                                                <button type="submit" class="btn btn-primary"><i
                                                        class="fa fa-check-circle mr-1"></i> Verifikasi Data
                                                    Survei</button>
                                            </form>
                                            @endif
                                        </div>
